...
5. 不要假设论文没有包含某些内容——如果文本中提到了表格、图表、算法，就认为它们存在
6. 注意：表格和图片可能以文字描述、引用编号（如表4.1、图3.2）的形式出现，这些都表明它们存在
7. 附录中的表格和图片同样有效，不应声称缺失
8. 不要质疑论文的研究设计方向（如"为什么只研究一种粉尘"），除非论文自身声称研究了多种但实际只做了
9. 不要声称摘要与正文不一致，除非你能指出具体的不一致之处并引用原文
...
8. 附录中的内容同样有效
9. 不要声称"未引用对比文献"，除非你确认参考文献部分确实没有
